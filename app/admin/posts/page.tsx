        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-[#38200D]/10">
              <th className="text-left px-5 py-3 text-xs font-semibold text-[#38200D]/50 uppercase tracking-wider">
                Post
              </th>
              <th className="text-left px-5 py-3 text-xs font-semibold text-[#38200D]/50 uppercase tracking-wider hidden md:table-cell">
                Tags
              </th>
              <th className="text-left px-5 py-3 text-xs font-semibold text-[#38200D]/50 uppercase tracking-wider hidden lg:table-cell">
                Date
              </th>
              <th className="text-left px-5 py-3 text-xs font-semibold text-[#38200D]/50 uppercase tracking-wider hidden sm:table-cell">
                Status
              </th>
                ...
                <td className="px-5 py-3 hidden md:table-cell">
                  <div className="flex flex-wrap gap-1">
                    {post.tags.slice(0, 2).map((tag) => (
                      <span
                        key={tag}
                        className="px-2 py-0.5 bg-[#FFBE0B]/15 text-[#38200D] text-xs rounded-full border border-[#FFBE0B]/30"
                      >
                        {tag}
                      </span>
                    ))}
        ...
        <div className="flex items-center justify-between px-5 py-3 border-t border-[#38200D]/10">
          ...
          <div className="flex gap-1">
            {[1].map((n) => (
              <button
                key={n}
                className="w-7 h-7 text-xs font-medium rounded-lg bg-[#FB5607] text-white"
              >
                {n}
              </button>
            ))}
